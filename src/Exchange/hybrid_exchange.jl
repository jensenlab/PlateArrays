...
"""
function hybrid_exchange(P::Int,N::Int,wells::BitMatrix;restarts::Int=10,iterations::Int=1000,kwargs...)
    ...
    for i in 1:restarts 
        ...
        min_dist_design=distance_exchange(P,N,wells;restarts=restarts,iterations=iterations)
        max_dist_design=distance_exchange(P,N,wells;minimize=false,restarts=restarts,iterations=iterations)
